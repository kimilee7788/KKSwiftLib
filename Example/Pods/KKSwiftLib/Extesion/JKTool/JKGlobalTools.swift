...
public struct JKGlobalTools {
    ...
    public static func compareVersion(version: String) -> Bool {
        ...
        // 2、当前版本的版本号获取 三位Int值
        let currentVersion = Bundle.km.appVersion
...
private extension JKGlobalTools {
    ...
    static func appVersion(version: String) -> (isSuccess: Bool, versions: [Int]) {
        let versionArray = version.km.separatedByString(with: ".")
        ...
        guard let versionValue1 = versionString1.km.toInt(), let versionValue2 = versionString2.km.toInt(), let versionValue3 = versionString3.km.toInt() else {
            return (false, [])
        }
