...
public extension JKPOP where Base: UILabel {
    ...
    func accordWidthLinesCountAndLinesContent(accordWidth: CGFloat, lineSpace: CGFloat, textSpace: CGFloat = 0.0, paraSpace: CGFloat = 0.0) -> (Int?, [String]?) {
        ...
        let contentDict = UILabel.km.genTextStyle(text: t as NSString, linebreakmode: NSLineBreakMode.byCharWrapping, align: align, font: f, lineSpace: lineSpace, textSpace: textSpace, paraSpace: paraSpace)
        ...
        for line in lines {
            ...
            let lineString = t.km.sub(start: lineRange.location, length: lineRange.length)
    ...
    func linesCountAndLinesContent() -> (Int?, [String]?) {
        ...
        let path = CGMutablePath()
        /// 2.5 是经验误差值
        path.addRect(CGRect(x: 0, y: 0, width: base.km.width, height: base.km.height > (fp * 1.5) ? base.km.height : fp * 1.5))
        let framef = CTFramesetterCreateFrame(frameSetter, CFRangeMake(0, 0), path, nil)
        let lines = CTFrameGetLines(framef) as NSArray
        var lineArr = [String]()
        for line in lines {
...
public extension JKPOP where Base: UILabel {
    ...
    func setRangeFontText(font: UIFont, range: NSRange) {
        let attributedString = base.attributedText?.km.setRangeFontText(font: font, range: range)
    ...
    func setsetSpecificTextFont(_ text: String, font: UIFont) {
        let attributedString = base.attributedText?.km.setSpecificTextFont(text, font: font)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeTextColor(color: UIColor, range: NSRange) {
        let attributedString = base.attributedText?.km.setSpecificRangeTextColor(color: color, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextColor(_ text: String, color: UIColor) {
        let attributedString = base.attributedText?.km.setSpecificTextColor(text, color: color)
        base.attributedText = attributedString
    }
    ...
    func setTextLineSpace(_ space: CGFloat) {
        let attributedString = base.attributedText?.km.setSpecificRangeTextLineSpace(lineSpace: space, alignment: base.textAlignment, range: NSRange.init(location: 0, length: base.text?.count ?? 0))
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeTextUnderLine(color: UIColor, stytle: NSUnderlineStyle = .single, range: NSRange) {
        let attributedString = base.attributedText?.km.setSpecificRangeUnderLine(color: color, stytle: stytle, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextUnderLine(_ text: String, color: UIColor, stytle: NSUnderlineStyle = .single) {
        let attributedString = base.attributedText?.km.setSpecificTextUnderLine(text, color: color, stytle: stytle)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeDeleteLine(color: UIColor, range: NSRange) {
        let attributedString = base.attributedText?.km.setSpecificRangeDeleteLine(color: color, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextDeleteLine(_ text: String, color: UIColor) {
        let attributedString = base.attributedText?.km.setSpecificTextDeleteLine(text, color: color)
        base.attributedText = attributedString
    }
    ...
    func insertImage(imgName: String, imgBounds: CGRect = .zero, imgIndex: Int = 0) {
        ...
        let attributedString = base.attributedText?.km.insertImage(imgName: imgName, imgBounds: imgBounds, imgIndex: imgIndex)
        base.attributedText = attributedString
    }
    ...
    func firstLineLeftEdge(_ edge: CGFloat) {
        let attributedString = base.attributedText?.km.firstLineLeftEdge(edge)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeBliqueness(inclination: Float = 0, range: NSRange) {
        let attributedString = base.attributedText?.km.setSpecificRangeBliqueness(inclination: inclination, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextBliqueness(_ text: String, inclination: Float = 0) {
        let attributedString = base.attributedText?.km.setSpecificTextBliqueness(text, inclination: inclination)
        base.attributedText = attributedString
    }
}
