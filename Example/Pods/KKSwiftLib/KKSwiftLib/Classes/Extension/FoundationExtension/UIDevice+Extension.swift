...
public extension JKPOP where Base: UIDevice {
    ...
    static func screenType() -> UIDeviceScreenType {
        let modelName = Base.km.modelName
    ...
    static func isIphone5Screen() -> Bool {
        if Base.km.screenType() == .IPHONE_5 {
            return true
        }
        return false
    }
    ...
    static func isIphone6Screen() -> Bool {
        if Base.km.screenType() == .IPHONE_6 {
            return true
        }
        return false
    }
    ...
    static func isIphoneXScreen() -> Bool {
        if Base.km.screenType() == .IPHONE_X || Base.km.screenType() == .IPHONE_XS || Base.km.screenType() == .IPHONE_XR || Base.km.screenType() == .IPHONE_XS_Max ||  Base.km.screenType() == .IPHONE_11 ||  Base.km.screenType() == .IPHONE_11_PRO ||  Base.km.screenType() == .IPHONE_11_PRO_MAX {
            return true
        }
        return false
    }
    ...
    static func isIphoneXSScreen() -> Bool {
        if Base.km.screenType() == .IPHONE_XS || Base.km.screenType() == .IPHONE_XR || Base.km.screenType() == .IPHONE_XS_Max {
            return true
        }
        return false
    }
...
public extension JKPOP where Base: UIDevice {
    ...
    static var isJailbroken: Bool {
        ...
        let path = String(format: "/private/%@", String.km.stringWithUUID() ?? "")
        do {
