...
public extension JKPOP where Base: ExpressibleByStringLiteral {
    ...
    func toClass() -> AnyClass? {
        ...
        guard let Class: AnyClass = NSClassFromString(namespace.km.removeSomeStringUseSomeString(removeString: " ", replacingString: "_") + "." + (base as! String)) else {
            return nil
        }
        return Class
    }
...
public extension JKPOP where Base: ExpressibleByStringLiteral {
    ...
    var toNumber: NSNumber? {
        return self.toDouble()?.km.number
    }
}
...
extension JKPOP where Base: ExpressibleByStringLiteral {
    ...
    public var isValidIDCardNumStrict: Bool {
        ...
        case 15:
            ...
            year = Int(str.km.sub(start: 6, length: 2))!
        ...
        case 18:
            // 18位身份证
            year = Int(str.km.sub(start: 6, length: 4))!
            ...
            if numberOfMatch > 0 {
                ...
                for i in 0 ..< 17 {
                    if let d = Int(str.km.slice(i ..< (i + 1))) {
                        s += d * jiaoYan[i % 10]
                    } else {
                        return false
                    }
                ...
                let Y = s % 11
                let JYM = "10X98765432"
                let M = JYM.km.sub(start: Y, length: 1)
                if M == str.km.sub(start: 17, length: 1) {
                    return true
                } else {
                    return false
                }
...
extension JKPOP where Base: ExpressibleByStringLiteral {
    ...
    public func nsRange(of subString: String) -> NSRange? {
        guard (base as! String).km.contains(find: subString) else {
            return nil
        }
    ...
    public func insertString(content: String, locat: Int) -> String {
        ...
        let str1 = (base as! String).km.sub(to: locat)
        let str2 =  (base as! String).km.sub(from: locat + 1)
...
public extension JKPOP where Base: ExpressibleByStringLiteral {
    ...
    func binaryToOctal() -> String {
        ...
        // 八进制
        return decimal.km.decimalToOctal()
    }
    ...
    func binaryToHexadecimal() -> String {
        ...
        let decimal = binary.binaryTodecimal()
        // 十六进制
        return decimal.km.decimalToHexadecimal()
    }
    ...
    func octalTobinary() -> String {
        ...
        // 二进制
        return decimal.km.decimalToBinary()
    }
    ...
    func octalToHexadecimal() -> String {
        ...
        // 十进制
        let decimal = octal.km.octalTodecimal()
        // 十六进制
        return decimal.km.decimalToHexadecimal()
    }
    ...
    func decimalToBinary() -> String {
        guard var decimal = (self.base as! String).km.toInt() else {
            return ""
        }
        var str = ""
        while decimal > 0 {
    ...
    func decimalToOctal() -> String {
        guard let decimal = (self.base as! String).km.toInt() else {
            return ""
        }
        /*
