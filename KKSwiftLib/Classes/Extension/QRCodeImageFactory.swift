...
public struct QRCodeImageFactory {
    ...
    public static func qrCodeImage(content: String,
        ...
        if let newLogoRoundCorner = logoRoundCorner, let roundCornerLogo = logo.km.isRoundCorner(radius: newLogoRoundCorner, byRoundingCorners: .allCorners, imageSize: logoSize) {
